      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="space-y-5">
            <h3 className="text-2xl font-black font-heading text-gray-900 tracking-tighter italic uppercase">
            ...
            <div className="flex space-x-3 pt-2">
              <a href="https://instagram.com/nayea.id" className="p-3 bg-gray-50 text-gray-400 hover:text-primary hover:bg-primary/10 rounded-2xl transition-all">
          ...
          {/* Links */}
          <div>
            <h4 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.3em] italic mb-6">Shop</h4>
          ...
          {/* Support */}
          <div>
            <h4 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.3em] italic mb-6">Support</h4>
            <ul className="space-y-4 text-sm font-bold text-gray-700">
          ...
          {/* Contact */}
          <div>
            <h4 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.3em] italic mb-6">Contact</h4>
            <ul className="space-y-4 text-sm font-bold text-gray-700">
