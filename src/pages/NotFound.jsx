    ...
    <div className="min-h-screen bg-cream flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="max-w-md w-full text-center relative z-10">
        <div className="relative mb-10 group">
           ...
           <div className="relative w-32 h-32 bg-white rounded-[2.5rem] shadow-premium border border-cream flex items-center justify-center mx-auto transition-transform duration-500 group-hover:rotate-12 group-hover:scale-110">
              <AlertCircle className="w-12 h-12 text-rose-500 drop-shadow-sm" />
           </div>
           <div className="absolute -bottom-2 -right-2 bg-primary text-white px-4 py-2 rounded-xl text-lg font-black italic shadow-lg">404</div>
        </div>

        <h1 className="text-4xl font-black font-heading text-primary tracking-tighter italic uppercase leading-tight">
          Halaman Tidak <br /> <span className="text-primary italic">Ditemukan</span>
        </h1>
        
        <p className="mt-6 text-secondary font-medium leading-relaxed">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center gap-4">
           ...
           <Link 
            to="/catalog" 
            className="w-full py-4 px-8 bg-cream text-secondary rounded-2xl font-black uppercase tracking-widest text-xs flex items-center justify-center gap-2 hover:bg-oat transition-all"
           >
        ...
        <div className="mt-12 pt-12 border-t border-cream">
           <div className="flex items-center justify-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-secondary-light italic">
