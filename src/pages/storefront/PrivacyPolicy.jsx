    ...
    <div className="bg-cream min-h-screen py-16 sm:py-24">
      ...
      <div className="max-w-3xl mx-auto px-6 sm:px-8">
        ...
        <div className="space-y-10 text-sm text-secondary font-medium leading-relaxed">
          <section>
            <h2 className="text-lg font-black font-heading text-primary uppercase italic mb-3">1. Data yang Kami Kumpulkan</h2>
          ...
          <section>
            <h2 className="text-lg font-black font-heading text-primary uppercase italic mb-3">2. Bagaimana Data Digunakan</h2>
          ...
          <section>
            <h2 className="text-lg font-black font-heading text-primary uppercase italic mb-3">3. Penyimpanan &amp; Keamanan</h2>
          ...
          <section>
            <h2 className="text-lg font-black font-heading text-primary uppercase italic mb-3">4. Pihak Ketiga</h2>
          ...
          <section>
            <h2 className="text-lg font-black font-heading text-primary uppercase italic mb-3">5. Hak Anda</h2>
          ...
          <section>
            <h2 className="text-lg font-black font-heading text-primary uppercase italic mb-3">6. Perubahan Kebijakan</h2>
