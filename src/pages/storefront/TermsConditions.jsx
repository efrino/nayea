    ...
    <div className="bg-white min-h-screen py-16 sm:py-24">
      ...
      <div className="max-w-3xl mx-auto px-6 sm:px-8">
        ...
        <div className="space-y-10 text-sm text-gray-600 font-medium leading-relaxed">
          <section>
            <h2 className="text-lg font-black font-heading text-gray-900 uppercase italic mb-3">1. Penerimaan Ketentuan</h2>
          ...
          <section>
            <h2 className="text-lg font-black font-heading text-gray-900 uppercase italic mb-3">2. Pemesanan</h2>
          ...
          <section>
            <h2 className="text-lg font-black font-heading text-gray-900 uppercase italic mb-3">3. Harga &amp; Pembayaran</h2>
          ...
          <section>
            <h2 className="text-lg font-black font-heading text-gray-900 uppercase italic mb-3">4. Pengiriman</h2>
          ...
          <section>
            <h2 className="text-lg font-black font-heading text-gray-900 uppercase italic mb-3">5. Penukaran &amp; Pengembalian</h2>
          ...
          <section>
            <h2 className="text-lg font-black font-heading text-gray-900 uppercase italic mb-3">6. Akun Pengguna</h2>
          ...
          <section>
            <h2 className="text-lg font-black font-heading text-gray-900 uppercase italic mb-3">7. Perubahan Ketentuan</h2>
